<template>
    <div>
        <div class="container">
            <div @click="showZhengcePop()" style="border-bottom: 1px solid #E3E3E3;padding-top: 5px;padding-bottom: 5px">
                <mt-cell title="隐私政策" value="" is-link>
                </mt-cell>
            </div>
            <div @click="showXieyiPop()" style="border-bottom: 1px solid #E3E3E3;padding-top: 5px;padding-bottom: 5px">
                <mt-cell title="法律信息" value="" is-link>
                </mt-cell>
            </div>
            <div @click="showVersion()" style="border-bottom: 1px solid #E3E3E3;padding-top: 5px;padding-bottom: 5px">
                <mt-cell title="版权信息" value="V1.0.0">
                </mt-cell>
            </div>
            <!--            <div class="content-item" @click="goToUserInfo()">-->
            <!--                <span>证照信息</span>-->
            ...
            <div class="showStatus" v-show="showZhengce">
                <div>
                    <div class="box" style="margin:0 auto;padding: 16px;">
        ...
        >
            ...
            <div class="showStatus" v-show="showXieyi">
                <div>
                    <div class="box" style="margin:0 auto;padding:56px 16px 0;">
        ...
        <span
                style="mso-spacerun:'yes';font-family:宋体;mso-ascii-font-family:'Times New Roman';mso-hansi-font-family:'Times New Roman';mso-bidi-font-family:'Times New Roman';font-size:12.0000pt;mso-font-kerning:1.0000pt;"
        >权易宝平台由上海易涟信息技术有限公司运营，平台包含的全部智力成果包括但不限于数据库、网站设计、文字和图表、软件、照片、录像、音乐、声音及其前述组合，软件编译、相关源代码和软件（包括小应用程序和脚本）&nbsp;的知识产权权利均归上海易涟信息技术有限公司所有，您在使用权易宝平台的过程中应当尊重以上知识产权，并按《用户注册服务协议》及《隐私政策》的要求使用平台服务。</span>
                                    <span
                                            style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:宋体;font-size:12.0000pt;mso-font-kerning:1.0000pt;"
                                    >
        ...
        >
          联系邮箱：
          <font face="Times New Roman">service@e-pex.com</font>
        </span>
                                    <span
                                            style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:宋体;font-size:12.0000pt;mso-font-kerning:1.0000pt;"
                                    >
